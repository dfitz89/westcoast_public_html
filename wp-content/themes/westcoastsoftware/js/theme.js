jQuery(function ($) {
  ...
  $('#Camo').click(function() {
      window.open('http://www.camocosmetics.com/store/catalog/', '_blank');
  });
  $('#Glin').click(function() {
      window.open('http://www.getlinkedinnow.com/', '_blank');
  });
  $('#Chens').click(function() {
      window.open( 'http://www.chenspanda.com', '_blank');
  });
  $('#WTP').click(function() {
      window.open('http://www.wtpgroup.com/', '_blank');
  });
  $('#ArmStar').click(function() {
      window.open('http://www.armstar.net/', '_blank');
  });
});
